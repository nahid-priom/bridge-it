...
import { Users, Award, Clock, Wallet } from 'lucide-react';
import { FREELANCER_BENEFITS } from '@/data/homeContent';
...
export function FreelancerBenefitsSection() {
  return (
    <section className="py-12 md:py-20 bg-surface" aria-labelledby="benefits-heading">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          Make it happen with <span className="text-deshi-green">freelancers</span>
        </h2>

        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
          {FREELANCER_BENEFITS.map((benefit) => {
