      ...
      {open && (
        <>
          ...
          <motion.div
            ...
            className="fixed top-0 left-0 bottom-0 z-[70] w-[min(100%,320px)] bg-background border-r border-border-subtle overflow-y-auto lg:hidden"
          >
            <div className="sticky top-0 z-10 flex items-center justify-between p-4 bg-background border-b border-border-subtle">
...
export const MobileFilterButton: React.FC<{
  ...
  <button
    onClick={onClick}
    className={`flex items-center gap-2 px-4 py-2.5 glass border border-border-subtle rounded-xl text-sm text-text-primary cursor-pointer ${focusVisibleRing}`}
  >
