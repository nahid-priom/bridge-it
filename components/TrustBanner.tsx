...
export const TrustBanner: React.FC = () => {
  ...
  return (
    <div className="py-5 border-y border-border-subtle bg-surface/30 overflow-hidden">
      <div className="flex animate-marquee gap-8 whitespace-nowrap">
        {[...items, ...items].map((item, i) => (
          <div key={i} className="flex items-center gap-2 text-text-muted/70 flex-shrink-0">
