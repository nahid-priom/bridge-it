...
export const SearchHeroBar: React.FC<SearchHeroBarProps> = ({
  ...
  return (
    ...
    >
      <button
        onClick={onGoHome}
        className="flex items-center gap-2 text-bridge-gray hover:text-white transition-colors mb-4 cursor-pointer text-sm"
      >
      ...
      <div className="glass-card rounded-2xl p-5 md:p-6 border border-white/10 relative overflow-hidden">
        ...
        <div className="relative">
          ...
          <p className="text-sm text-bridge-gray mb-5 max-w-2xl">
          ...
          >
            <div className="relative flex-1">
              ...
              <input
                ...
                className="w-full pl-12 pr-4 py-3.5 bg-bridge-dark-2 border border-white/10 rounded-xl text-white placeholder-bridge-gray focus:outline-none focus:border-bridge-primary focus:ring-2 focus:ring-bridge-primary/20"
                autoFocus
              />
            </div>
            <button
