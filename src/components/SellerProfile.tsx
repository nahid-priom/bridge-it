    ...
    <div className="min-h-screen pt-20 pb-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative rounded-2xl overflow-hidden mb-8">
          ...
          <div className="absolute inset-0 bg-gradient-to-t from-bridge-dark via-bridge-dark/50 to-transparent"></div>
          ...
          <div className="absolute bottom-0 left-0 right-0 p-6">
            <div className="flex flex-col md:flex-row md:items-end gap-4">
              ...
              <div className="flex-1">
                ...
                <p className="text-bridge-gray">{seller.tagline}</p>
              </div>
              <div className="flex gap-2">
                ...
                <button className="px-4 py-2.5 glass border border-white/10 text-white font-medium rounded-xl hover:bg-white/10 transition-colors flex items-center gap-2 cursor-pointer">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="space-y-4">
            ...
            <div className="glass rounded-2xl p-6">
              ...
              <div className="space-y-3">
                <div className="flex items-center justify-between">
                  <span className="text-sm text-bridge-gray flex items-center gap-2"><Star className="w-4 h-4 text-bridge-gold" /> Rating</span>
                  <span className="text-sm font-bold text-white">{seller.rating}/5.0 ({seller.reviewCount})</span>
                </div>
                <div className="flex items-center justify-between">
                  <span className="text-sm text-bridge-gray flex items-center gap-2"><Award className="w-4 h-4 text-bridge-secondary" /> Projects</span>
                  <span className="text-sm font-bold text-white">{seller.completedProjects}</span>
                </div>
                <div className="flex items-center justify-between">
                  <span className="text-sm text-bridge-gray flex items-center gap-2"><Clock className="w-4 h-4 text-bridge-cyan" /> Response</span>
                  <span className="text-sm font-bold text-white">{seller.responseTime}</span>
                </div>
                <div className="flex items-center justify-between">
                  <span className="text-sm text-bridge-gray flex items-center gap-2"><MapPin className="w-4 h-4 text-bridge-accent" /> Location</span>
                  <span className="text-sm text-white">{seller.location}</span>
                </div>
                <div className="flex items-center justify-between">
                  <span className="text-sm text-bridge-gray flex items-center gap-2"><Calendar className="w-4 h-4 text-bridge-pink" /> Joined</span>
                  <span className="text-sm text-white">{seller.joinedDate}</span>
                </div>
              </div>
            </div>
            ...
            {/* Category */}
            <div className="glass rounded-2xl p-6">
              <h3 className="text-lg font-bold text-white mb-3">Specialty</h3>
            ...
            <div className="glass rounded-2xl p-6">
              ...
              <div className="flex items-center gap-2">
                <input type="text" value={seller.customUrl} readOnly className="flex-1 px-3 py-2 bg-bridge-dark-3 border border-white/10 rounded-lg text-xs text-bridge-gray" />
                <button 
                  onClick={() => {
            ...
            <div className="glass rounded-2xl p-6">
              ...
              <p className="text-sm text-bridge-gray leading-relaxed">{seller.description}</p>
            </div>
          </div>

          {/* Right - Services & Gallery */}
          <div className="lg:col-span-2 space-y-6">
            <h3 className="text-xl font-bold text-white">Services by {seller.name}</h3>
            ...
            {sellerServices.length > 0 ? (
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {sellerServices.map(service => (
                  <div
                    ...
                    className="glass rounded-2xl overflow-hidden border border-white/5 hover:border-white/15 card-hover cursor-pointer"
                  >
                    ...
                    <div className="p-4">
                      <h4 className="text-sm font-bold text-white mb-2 line-clamp-2">{service.title}</h4>
                      <div className="flex items-center justify-between">
              ...
              <div className="glass rounded-2xl p-12 text-center">
                <Shield className="w-12 h-12 text-bridge-gray mx-auto mb-4" />
                <p className="text-bridge-gray">This seller's full service catalog is coming soon.</p>
              </div>
            )}
            ...
            <div>
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                {[1,2,3,4,5,6].map(i => (
                  <div key={i} className="relative aspect-square bg-bridge-dark-3 rounded-xl overflow-hidden watermark-overlay no-select group">
                    <img 
