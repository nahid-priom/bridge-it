    ...
    <div className="min-h-screen pt-20 pb-4">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <button 
          ...
          className="flex items-center gap-2 text-bridge-gray hover:text-white transition-colors mb-4 cursor-pointer"
        >
          <ArrowLeft className="w-4 h-4" /> Back
        </button>

        <div className="glass rounded-2xl overflow-hidden border border-white/10" style={{ height: 'calc(100vh - 140px)' }}>
          <div className="flex h-full">
            {/* Contacts List */}
            <div className={`${selectedChat ? 'hidden md:flex' : 'flex'} flex-col w-full md:w-80 lg:w-96 border-r border-white/10`}>
              {/* Search */}
              <div className="p-4 border-b border-white/10">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-4 py-2 bg-bridge-dark-3 border border-white/10 rounded-xl text-sm text-white placeholder-bridge-gray focus:outline-none focus:border-bridge-primary"
                  />
                </div>
              </div>
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center justify-between">
                        ...
                        <span className="text-xs text-bridge-gray">{contact.time}</span>
                      </div>
                      <p className="text-xs text-bridge-gray truncate">{contact.lastMessage}</p>
                    </div>
                    {contact.unread > 0 && (
            ...
            {selectedChat && activeContact ? (
                ...
                <div className="flex items-center justify-between p-4 border-b border-white/10">
                  <div className="flex items-center gap-3">
                    <button 
                      ...
                      className="md:hidden p-1 text-bridge-gray cursor-pointer"
                    >
                  ...
                  <div className="flex items-center gap-2">
                    <button className="p-2 text-bridge-gray hover:text-white transition-colors cursor-pointer">
                ...
                <div className="p-4 border-t border-white/10">
                  <div className="flex items-center gap-2">
                    ...
                    <input
                      ...
                      className="flex-1 px-4 py-2.5 bg-bridge-dark-3 border border-white/10 rounded-xl text-sm text-white placeholder-bridge-gray focus:outline-none focus:border-bridge-primary"
                    />
                    <button className="p-2 text-bridge-gray hover:text-white transition-colors cursor-pointer">
              ...
              <div className="hidden md:flex flex-1 items-center justify-center">
                <div className="text-center">
                  <div className="w-20 h-20 bg-bridge-dark-3 rounded-full flex items-center justify-center mx-auto mb-4">
                    <Send className="w-8 h-8 text-bridge-gray" />
                  </div>
                  <h3 className="text-lg font-bold text-white mb-2">Select a conversation</h3>
                  <p className="text-sm text-bridge-gray">Choose a contact to start messaging</p>
                </div>
              </div>
            )}
          </div>
