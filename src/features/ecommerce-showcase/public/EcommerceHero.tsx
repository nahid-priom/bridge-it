...
export function EcommerceHero() {
  return (
    <section className="relative mb-2 overflow-hidden lg:mb-8">
      <div
        aria-hidden
      ...
      />
      <div className="relative mx-auto w-full max-w-[1480px] px-4 pt-[calc(var(--header-offset)+0.15rem)] pb-0 sm:px-6 lg:px-8 lg:pt-[calc(var(--header-offset)+0.75rem)] lg:pb-2 xl:px-10">
        <div className="grid min-w-0 grid-cols-1 items-start gap-8 lg:grid-cols-2 lg:items-center lg:gap-8 xl:gap-10">
