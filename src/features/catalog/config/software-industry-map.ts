...
export const SOFTWARE_PRODUCT_INDUSTRY_MAP = {
  ...
  'garments-merchandising-management': 'garments',
  'garments-cutting-sewing-management': 'garments',
  'garments-inventory-warehouse': 'garments',
  'garments-hr-payroll': 'garments',
  'garments-commercial-export-management': 'garments',
  ...
  'feed-production-management': 'feed-mill',
  'feed-formula-costing-software': 'feed-mill',
  'feed-dealer-distribution-management': 'feed-mill',
  'feed-mill-inventory-warehouse': 'feed-mill',
  'feed-mill-accounts-finance': 'feed-mill',
