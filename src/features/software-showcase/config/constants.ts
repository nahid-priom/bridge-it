...
export const SOFTWARE_HOMEPAGE_SECTION_MAX = 6;
...
export const SOFTWARE_HOMEPAGE_SECTIONS = [
  {
    ...
    description: 'Ready systems for retail, HR, CRM, dealership and more.',
  ...
  },
  {
    ...
    eyebrow: 'Industry',
    description: 'Manufacturing, agro, garments and factory-ready platforms.',
