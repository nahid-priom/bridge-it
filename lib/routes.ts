export const ROUTES = {
  ...
  ecommerceShowroom: '/solutions/ecommerce',
  ecommerceSolution: (slug: string) => `/solutions/ecommerce/${slug}`,
  ecommerceSolutionOrder: (slug: string) => `/solutions/ecommerce/${slug}/order`,
  ecommerceDemo: (demoSlug: string) => `/demo/ecommerce/${demoSlug}`,
  softwareShowroom: '/solutions/software',
  softwareSolution: (slug: string) => `/solutions/software/${slug}`,
  softwareSolutionOrder: (slug: string) => `/solutions/software/${slug}/order`,
