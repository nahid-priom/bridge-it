...
const PRODUCTS = [
  {
    ...
    screens: [
      { key: 'dashboard-overview', name: 'Dashboard Overview' },
      { key: 'products', name: 'Product Management' },
      { key: 'orders', name: 'Orders Management' },
      { key: 'inventory', name: 'Inventory / Stock' },
      { key: 'courier', name: 'Courier Management' },
      { key: 'customers', name: 'Customer Management' },
      { key: 'analytics', name: 'Analytics' },
      { key: 'discounts', name: 'Discounts / Promotions' },
      { key: 'payments', name: 'Payment / Transaction' },
